...
scene.title = "Pololu MinIMU-9 + Arduino AHRD"
...
label(pos=vector(-0.4,0.3,0),text="Roll",box=0,opacity=0)
label(pos=vector(0.1,0.3,0),text="Pitch",box=0,opacity=0)
...
L1 = label(pos=vector(-0.4,0.22,0),text="-",box=0,opacity=0)
L2 = label(pos=vector(0.1,0.22,0),text="-",box=0,opacity=0)
